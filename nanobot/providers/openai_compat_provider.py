...
class OpenAICompatProvider(LLMProvider):
    ...
    def __init__(
        ...
        self.extra_headers = {
            key: normalize_provider_input(value, field_name=f"extra_headers.{key}") or ""
        ...
        effective_base = self.api_base or (spec.default_api_base if spec else None) or None
        ...
        if self.extra_headers:
            self._default_headers.update(self.extra_headers)
        self._api_key_for_client = self.api_key or "no-key"
